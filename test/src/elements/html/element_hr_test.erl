...
basic_test_() ->
    [?_assertEqual("<hr id='123123' class='hr'/>",new_hr_1()),
     ?_assertEqual("<hr id='123125' class='hr t_hr'/>",new_hr_2()),
     ?_assertEqual("<hr id='123125' class='hr t_hr' style='color: cyan;'/>",new_hr_3())
    ].
