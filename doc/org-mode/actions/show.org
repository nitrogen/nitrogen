...
* Show Action - #show {}
  ...
  If an effect is specified, then call JQuery UI's [[http://docs.jquery.com/UI/Effects/show][show(effect,
  options, speed)]] on the target element.
