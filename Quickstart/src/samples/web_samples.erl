...
main() ->	
	#template { file="./templates/twocolumn.html", bindings=[
		{'Group', learn},
		{'Item', samples}
	]}.
...
column2() -> [
	...
	#link { text="Set Content Type", url="/web/samples/contenttype" }, #br{},
	#link { text="HTTP Headers", url="/web/samples/headers" }, #br{},
    	#link { text="Security", url="/web/samples/security" }
].
