...
main() ->
	...
	Body = #body { title="Effects Example", body=[
		"
		<style>
		...
		#panel { style="margin: 50px;", body=[
			...
			#h1 { text="Effects Example" },
			#panel { style="width: 300px; float: left;", body=[
				...
				#link { text="Animate - Margins", actions=Event#event { 
					actions=#animate { options=[{margin, "50px"}, {padding, "20px"}, {borderWidth, "10px"}] }
				}}, 
				#br{},
				#br{}			
			]},
			#panel { style="width: 300px; float: left; border: solid 1px black;", id=theDiv, body=[
				"
